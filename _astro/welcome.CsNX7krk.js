import{c as n,r as o,m as s}from"./instance.BIgyk8SH.js";import{u as a}from"./PostsSearch.BbvsMOfr.js";import"./astro/assets-service.DtTBvDyw.js";import"./index.ibZwBGDH.js";import"./hrefs.DhMKepVc.js";const t=`<h1 id="welcome-to-my-site">Welcome to my site!</h1>
...
<pre class="astro-code github-dark" style="background-color:#24292e;color:#e1e4e8; overflow-x: auto;" tabindex="0" data-language="js"><code><span class="line"><span style="color:#F97583">let</span><span style="color:#E1E4E8"> message </span><span style="color:#F97583">=</span><span style="color:#9ECBFF"> 'Hello'</span><span style="color:#E1E4E8">;</span></span>
...
<span class="line"><span style="color:#B392F0">prnt</span><span style="color:#E1E4E8">(message);</span></span>
...
<p>No guarantees. <a href="#user-content-fnref-guarantee" data-footnote-backref="" aria-label="Back to reference 1" class="data-footnote-backref">↩</a></p>
</li>
</ol>
</section>`,l={title:"Welcome",description:"Welcome to my personal site!",date:"2022-03-30T17:40:00.000Z",tags:["meta"],language:"en"},r="/home/runner/work/skornel02/skornel02/website/src/content/posts/welcome.md",i=void 0;function b(){return`
# Welcome to my site!
...
`}function E(){return t}function w(){return[{depth:1,slug:"welcome-to-my-site",text:"Welcome to my site!"},{depth:2,slug:"goals",text:"Goals"},{depth:2,slug:"disclaimer",text:"Disclaimer"},{depth:2,slug:"footnote-label",text:"Footnotes"}]}const k=n((p,c,m)=>{const{layout:h,...e}=l;return e.file=r,e.url=i,o`${s()}${a(t)}`});export{k as Content,E as compiledContent,k as default,r as file,l as frontmatter,w as getHeadings,b as rawContent,i as url};
