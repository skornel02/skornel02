import{c as l,s as r,r as i,m as p}from"./_astro_assets.bfab6304.js";import{u as c}from"./PostsSearch.47d57eb9.js";import"./preload-helper.cf010ec4.js";import"./index.6f627cb5.js";const o={};function m(t){return t.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(a,e)=>r({src:o[e].src,...o[e].attributes}))}const s=m(`<h1 id="welcome-to-my-site">Welcome to my site!</h1>
...
</section>`),d={title:"Welcome",description:"Welcome to my personal site!",date:"2022-03-30T17:40:00.000Z",tags:["meta"],language:"en"},h="/home/runner/work/skornel02/skornel02/website/src/content/posts/welcome.md",u=void 0;function w(){return`
# Welcome to my site!
...
`}function k(){return s}function F(){return[{depth:1,slug:"welcome-to-my-site",text:"Welcome to my site!"},{depth:2,slug:"goals",text:"Goals"},{depth:2,slug:"disclaimer",text:"Disclaimer"},{depth:2,slug:"footnote-label",text:"Footnotes"}]}const T=l((t,a,e)=>{const{layout:g,...n}=d;return n.file=h,n.url=u,i`${p()}${c(s)}`});export{T as Content,k as compiledContent,T as default,h as file,d as frontmatter,F as getHeadings,o as images,w as rawContent,u as url};
